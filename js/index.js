$(function() {
    ...
    let gameController = {
        ...
        recalculateSizes : function (height, width) {
            ...
            if ((height < this.sceneMinH) && (width < this.sceneMinW)) {
                this.setExtremeValues(this.sceneMinH, this.sceneMinW);
            }

            if ((height > this.sceneMaxH) && (width > this.sceneMaxW)) {
                this.setExtremeValues(this.sceneMaxH, this.sceneMaxW);
            } else {
                this.sky.height(height * 0.6);
                this.ice.height(height * 0.3);
                this.glacier.height(height * 0.1);
            }
        }
    };
